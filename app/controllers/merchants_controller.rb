class MerchantsController < ApplicationController
  ...
  private
    ...
    def merchant_params
      parameter = params.require(:merchant).permit(:name, :email, :status, :amount, :total_transaction_sum, :password_confirmation, :password)
      if ((params['action'] == "update") && (params.dig(:merchant, :with_password) == '0'))
        parameter.except(:password, :password_confirmation)
      else
        parameter
      end
    end
