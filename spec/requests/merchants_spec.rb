...
RSpec.describe "/merchants", type: :request do
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      let(:new_attributes_with_password) {
        { name: 'User1', with_password: '1'}
      }
      ...
      it "updates the requested merchant" do
        ...
        merchant.reload
        expect(merchant.name).to eq 'User'
      end

      it "updates the requested with password merchant" do
        merchant = Merchant.create! valid_attributes
        patch merchant_url(merchant), params: { merchant: new_attributes_with_password }
        merchant.reload
        expect(merchant.name).to eq 'User1'
      end
